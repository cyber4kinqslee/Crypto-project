                        ...
                        <div class="page-next">
                            <nav aria-label="breadcrumb" class="d-inline-block">
                                <ul class="mb-0 bg-white rounded shadow breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?=base_url('/')?>">Bestcoinscental</a></li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="pt-2 mt-4 col-lg-5 col-md-5 mt-sm-0 pt-sm-0">
                    <div class="position-relative">
                        <img src="<?=base_url('paynerocket/storage/app/public/photos/iAwfKeabout.png')?>" class="mx-auto rounded img-fluid d-block" alt="">
                        <div class="play-icon">
                ...
                <div class="pt-2 mt-4 col-lg-7 col-md-7 mt-sm-0 pt-sm-0">
                    <div class="section-title ml-lg-4">
                        ...
                        <a href="<?=base_url('login')?>" class="mt-3 btn btn-primary">Invest now<i class="mdi mdi-chevron-right"></i></a>
                    </div>
                </div>
                <!--end col-->
            </div>
                ...
                <div class="row align-items-end">
                    <div class="col-md-8">
                        <div class="text-center section-title text-md-left">
                            <h4 class="mb-3 text-white title title-dark">World-class automated crypto trading and investment platform</h4>
                            <p class="mb-0 text-white">Powerful, AI-powered crypto investment and trading bot to help you save time, trade 24/7, and automate your trading.</p>
                        </div>
                    </div>
                    <!--end col-->
