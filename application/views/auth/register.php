		...
		<style>
            ...
            <div class="pb-3 row justify-content-center">
				...
				<a class="logo mx-auto d-flex justify-content-center" href="<?=base_url('/')?>">
                    ...
                    <div class="bg-white shadow card login-page roundedd border-1 px-5">
                        <div class="card-body">
                            <h4 class="text-center default-color card-title">Create an Account</h4>
							<?php
                        ...
                        <?php echo form_open(base_url( 'signup' ), array( 'id' => 'registerForm' ));?>
                                 <input type="hidden" name="_token" value="mLEv3SzctXeZA1SW0U6RRhH81dO0W3WIpt1Nziag">                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="default-color"><?php echo lang("first_name") ?><span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="user" class="default-color fea icon-sm icons"></i>
                                                <input type="text" id="input1" style="padding-left:5rem!important; font-size:15px!important;" class="form-control" name="firstname" id="input1" placeholder="<?php echo lang("first_name") ?>" value="<?=set_value('firstname')?>">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="default-color"><?php echo lang("last_name") ?> <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="user-check" class="default-color fea icon-sm icons"></i>
                                                <input type="text" style="padding-left:5rem!important; font-size:15px!important;" class="form-control" name="lastname" id="f_name" placeholder="<?php echo lang("last_name") ?>" value="<?=set_value('lastname')?>">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <input type="email" style="padding-left:5rem!important; font-size:15px!important;" class="form-control" name="email" id="email" placeholder="<?php echo lang("email") ?>" value="<?=set_value('email')?>">
                                                                                            </div>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="default-color"><?php echo lang("phone") ?>  <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="phone" class="default-color fea icon-sm icons"></i>
                                                <input type="number" style="padding-left:5rem!important; font-size:15px!important;" pattern="\d*" maxlength="11" class="form-control" name="mobile" id="phone" placeholder="Enter Phone Number" value="<?=set_value('mobile')?>">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="default-color"><?php echo lang("confirm_password") ?> <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="key" class="default-color fea icon-sm icons"></i>
                                                <input type="password" style="padding-left:5rem!important; font-size:15px!important;" class="form-control" name="cpassword" id="confirm-password" placeholder="<?php echo lang("confirm_password") ?>" value="<?=set_value('cpassword')?>">
                                    ...
                                    <!-- <div class="col-md-12">
                                        ...
                                        <option value="Zimbabwe">Zimbabwe</option>                                                </select>
                                                                        ...
                                                                        <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="default-color"><?php echo lang("referral_code") ?> <span class="text-danger">*</span></label>
                                            <div class="position-relative">
                                                <i data-feather="user" class="default-color fea icon-sm icons"></i>
                                                <input type="text" style="padding-left:5rem!important; font-size:15px!important;" class="form-control" name="ref" placeholder="<?php echo lang("referral_code") ?>" value="<?php echo $this->security->xss_clean($code) ?>">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php }?>
                                    ...
                                    <div class="mb-0 col-lg-12">
										...
										<button type="submit" id="submit" class="btn btn-primary btn-block pad" data-loading-text="<?php echo lang('processing_data') ?>" data-title="<?php echo lang("create_account") ?>"><?php echo lang("create_account") ?></button>
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0"><small class="mr-2 text-dark">Already have an account
                                                </small> <a href="<?php echo base_url("login") ?>" class="text-dark font-weight-bold"><?php echo lang("login") ?></a></p>
                                    </div>
                                    <!--end col-->
