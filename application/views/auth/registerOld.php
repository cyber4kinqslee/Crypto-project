                        ...
                        <?php echo form_open(base_url( 'signup' ), array( 'id' => 'registerForm' ));?>
                          <div class="row">
                            ...
                            <!-- /form group -->
							  ...
							  <!-- Form Group -->
							  <div class="form-group">
                                <label class="sr-only" for="mobile-1"><?php echo lang("mobile") ?></label>
                                <input type="number" maxlength="11" class="form-control" name="mobile" id="mobile"
                                    aria-describedby="mobile-1" placeholder="Mobile number">
                                    <label class="error" id="email"></label>
                            </div>
                            <!-- /form group -->
