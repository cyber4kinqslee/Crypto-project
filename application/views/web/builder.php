            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6 offset-lg-0">
                    <div class="who-we-contant">
                        ...
                        <div class="fadeInUp" data-wow-delay="0.4s" id="mce_7" contenteditable="true" style="font-size: 15px;line-height: 1.9;"><?php echo $this->web_model->getTemplateContent('card_1_content', $template)->value; ?></div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6 offset-lg-0">
                    <div class="who-we-contant">
                        ...
                        <div class="fadeInUp" data-wow-delay="0.4s" id="mce_12" contenteditable="true" style="font-size: 15px;line-height: 1.9;"><?php echo $this->web_model->getTemplateContent('card_3_content', $template)->value; ?></div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 offset-lg-0 col-md-12 no-padding-left">
                    <div class="welcome-meter wow fadeInUp mb-30 main-pg-txt a-delay-7" data-wow-delay="0.7s">
