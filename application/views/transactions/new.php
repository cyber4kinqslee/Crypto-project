                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6 col-12 order-xl-1 z20">
                        ...
                        <div class="dt-card">
                            ...
                            <!-- Card Body -->
                            <?php if($pageTitle == 'New Deposits' && $companyInfo['kyc_allow_deposits'] == 0 && $isVerified != 'Verified' && ($role != ROLE_ADMIN && $role != ROLE_MANAGER)) {?>
                            <div class="card-body">
                                <!-- Card Title-->
                                ...
                                <!-- /card link-->
                            <?php } else if($pageTitle == 'New Withdrawal' && $companyInfo['kyc_allow_withdrawals'] == 0 && $isVerified != 'Verified' && ($role != ROLE_ADMIN && $role != ROLE_MANAGER)) {?>
                            <div class="card-body">
                                <!-- Card Title-->
                                <h2 class="card-title">Please Verify your account</h2>
                                <!-- Card Title-->
                                ...
                                <a href="<?php echo base_url('verify') ?>"
                                    class="btn btn-info text-uppercase">Verify</a>
                                <!-- /card link-->
                            <?php } else if(empty($userInfo->pmtAccount) && ($role != ROLE_ADMIN && $role != ROLE_MANAGER)) {?>
                            <div class="card-body">
                                <!-- Card Title-->
