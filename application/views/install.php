    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <?php if($config == 1 && $routes == 1 && $autoload == 1 && $uploads == 1 && $htaccess_exists == 1){?>
                ...
                <!-- -->
                <form class="needs-validation" novalidate="" id="install_form" method="post" action="<?php echo base_url(); ?>">
                    <div class="mb-3">
                ...
                <?php } else {?>
                <?php if($autoload != 1 || $config != 1 || $routes != 1 || $uploads != 1) {?>
