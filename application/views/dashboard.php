                    ...
                    <div class="col-md-12">
                        <div class="card bg-gradient-blue text-white">
                            ...
                            <div class="card-body p-6">
                                <p class="display-4 mb-1"><?= $isVerified; ?></p>
                                <p class="f-14">
                                <?php
                                    if($isVerified == 'Verify Your Account'){
                                        echo 'Please verify your account.';
                                    } else if($isVerified == 'Pending Verification'){
                                        echo 'Your details have been received. Please wait for them to be sorted out by our team';
                                    } else if($isVerified == 'Verified'){
                                        echo 'Your account has been verified';
                                    } else if($isVerified == 'Pending Resubmission'){
                                        echo 'Some of your verification details have been rejected, please resubmit them again';
                                    } else if($isVerified == 'Rejected'){
                                        echo 'Your details have been rejected';
                                    }  ?>
                                </p>
                                <?php
                                    if($isVerified == 'Verify Your Account'){ ?>
                                <a class="btn btn-default btn-sm text-dark"
                                    href="<?php echo base_url('verify') ?>">Verify</a>
                                    <?php } else if($isVerified == 'Pending Resubmission'){ ?>
                                <a class="btn btn-default btn-sm text-dark"
                                    href="<?php echo base_url('verify') ?>">Resubmit Documents</a>
                                    <?php } ?>
                            </div>
                            <!-- /card body -->
                        </div>
