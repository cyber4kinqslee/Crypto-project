                                ...
                                <div class=""><!---->
                                    <div id="hpdk" data-url="<?php echo base_url('bulk_assign_ticket') ?>" class="dt-module__list ng-star-inserted"><!---->
                                        <?php foreach($verifications as $task) {?>
                                            <a class="helpdesk dt-module__list-item ng-star-inserted" href="<?php echo base_url('kyc-portal/').$task->id ?>">
                                                <div>
                                                ...
                                                <div class="dt-module__list-item-content">
                                                    <div class="user-detail">
                                                        ...
                                                        <span class="designation"><?php echo $task->userEmail ?></span>
                                                        <task-badges style="margin-left: 3em;">
                                                            <div class="badge-group ng-star-inserted">
                                                                ...
                                                                <?php } else { ?>
                                                                    <span class="assigned-badge badge badge-primary ng-star-inserted text-capitalize">Assigned To: <?= $task->assignedToFirstName.'&nbsp'.$task->assignedToLastName ?></span>
                                                                <?php }?>
                                                            </div>
                                                        </task-badges>
                                                    </div>
                                                ...
                                                <div class="dt-module__list-item-info">
                                                    <span>Date updated: <?php echo date("d M y H:i",strtotime($task->createdDtm)) ?></span>
                                                    <button class="assigned-badge badge badge-primary ng-star-inserted text-capitalize kycapplication" data-url="<?=base_url('kyc-verification-info/').$task->id?>" data-form="<?=base_url('kyc-verify/').$task->id?>">View KYC Details</button>
                                                </div>
                                            </a>
                                        <?php }?>
                                    </div>
