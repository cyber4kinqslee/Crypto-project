            ...
            <div class="dt-customizer__inner">
                ...
                <div class="dt-customizer__header">
                    ...
                    <div class="dt-customizer__title" style="display: flex;">
                        <h3 class="mb-0 text-capitalize" id="lang-header">KYC Details</h3>
                ...
                <div class="loader" id="LangSettingsloader" style="display: none;"></div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <p>Identification Document <d class="text-capitalize" id="id_type"></d></p>
                        </div>
                        <div class="col-md-6" style="display: flex;">
                            ...
                            <button class="assigned-badge badge badge-primary ng-star-inserted text-capitalize float-left viewdoc" id="submittedid" data-title="Submitted Identification Document" data-toggle="modal" data-target="#documentModal">Submitted Doc</button>  
                        </div>
                    </div>  
                    <?php echo form_open(base_url(), array('id' => 'kycForm'));?>
                    <!-- Form Group -->
                    <div class="form-group">
                        <label for="payouts">ID Approval Status</label>
                        <br>
                        <!-- Radio Button -->
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="approveidverificationstatus" name="idverificationstatus" value="1" class="custom-control-input">
                            <label class="custom-control-label" for="approveidverificationstatus">Approved
                            </label>
                        </div>
                        <!-- /radio button -->
                        <!-- Radio Button -->
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="rejectidverificationstatus">Rejected
                            </label>
                        </div>
                        <!-- /radio button -->
                    </div>
                    ...
                    <div class="form-group hide" id="rejectionreason1">
                        <label for="rejectionreason1">Rejection reason</label>
                        <textarea 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                        <p>Address Verification Document <d class="text-capitalize" id="address_type"></d></p>
                        </div>
                        <div class="col-md-6" style="display: flex;">
                            ...
                            <button class="assigned-badge badge badge-primary ng-star-inserted text-capitalize float-left viewdoc" id="submittedaddress" data-title="Submitted Address Document" data-toggle="modal" data-target="#documentModal">Submitted Doc</button>  
                        </div>
                    </div>  
                    <!-- Form Group -->
                    <div class="form-group">
                        <label for="payouts">Approval Status</label>
                        <br>
                        <!-- Radio Button -->
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="approveaddressverification" name="approveaddressverification" value="1" class="custom-control-input">
                            <label class="custom-control-label" for="approveaddressverification">Approved
                            </label>
                        </div>
                        <!-- /radio button -->
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="rejectaddressverification">Rejected
                            </label>
                        </div>
                        <!-- /radio button -->
                    </div>
                    ...
                    <div class="form-group hide" id="rejectionreason2">
                        <label for="rejectionreason2">Rejection reason</label>
                        <textarea 
