                                ...
                                <ul class="card-header-links nav nav-underline" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#tab-pane5" role="tab"
                                            aria-controls="tab-pane5" aria-selected="true">KYC Verification Settings</a>
                                    </li>
                                    <?php if($isDemo == false) {?>
                                    <li class="nav-item">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <!-- Form Group -->
                                                                    <div class="form-group">
                                                                        <label for="payouts">Activate KYC Feature</label>
                                                                        <br>
                                                                        <!-- Radio Button -->
                                                                    ...
                                                                    <div class="form-group <?= $companyInfo['kyc_status'] == 0 ? 'hide' : ''; ?>" id="allowdepositskycfield">
                                                                        <label for="payouts">Allow client deposits without KYC verification</label>
                                                                        <br>
                                                                        <!-- Radio Button -->
                                                                        <div class="custom-control custom-radio custom-control-inline">
                                                                            ...
                                                                            <label class="custom-control-label" for="kycdepositsallow">Yes
                                                                            </label>
                                                                        </div>
                                                                        <!-- /radio button -->
                                                                        <!-- Radio Button -->
                                                                        <div class="custom-control custom-radio custom-control-inline">
                                                                            ...
                                                                            <label class="custom-control-label" for="kycdepositsdeny">No
                                                                            </label>
                                                                        </div>
                                                                        <!-- /radio button -->
                                                                    ...
                                                                    <div class="form-group <?= $companyInfo['kyc_status'] == 0 ? 'hide' : ''; ?>" id="allowwithdrawalskycfield">
                                                                        <label for="payouts">Allow client withdrawals without KYC verification</label>
                                                                        <br>
                                                                        <!-- Radio Button -->
                                                                        <div class="custom-control custom-radio custom-control-inline">
                                                                            ...
                                                                            <label class="custom-control-label" for="kycwithdrawalsallow">Yes
                                                                            </label>
                                                                        </div>
                                                                        <!-- /radio button -->
                                                                        <!-- Radio Button -->
                                                                        <div class="custom-control custom-radio custom-control-inline">
                                                                            ...
                                                                            <label class="custom-control-label" for="kycwithdrawalsdeny">No
                                                                            </label>
                                                                        </div>
                                                                        <!-- /radio button -->
